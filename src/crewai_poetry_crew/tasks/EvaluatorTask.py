...
from crewai_poetry_crew.utilities.models import EvaluatorModel
...
def EvaluatorTask(
    ...
    agent_name = agent_name or "Evaluator"
    ...
    return Task(
        ...
        expected_output=EXPECTED_OUTPUT("EvaluatorModel"),
        agent=agent,
        context=context or [],
        output_pydantic=EvaluatorModel,
        callback=callback,
        verbose=verbose,
    )
