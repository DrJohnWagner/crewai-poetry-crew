...
from crewai_poetry_crew.utilities.models import SentinelModel
...
def SentinelTask(
    ...
    agent_name = agent_name or "Sentinel"
    ...
    return Task(
        ...
        expected_output=EXPECTED_OUTPUT("SentinelModel"),
        agent=agent,
        context=context or [],
        output_pydantic=SentinelModel,
        callback=callback,
        verbose=verbose,
    )
